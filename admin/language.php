    ...
    <div class="col-md-12">
		...
		<div class="box box-info">
            <div class="box-body">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Lưu<span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[4]" value="<?php echo $lang_ids[4]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Tải lên <span>*</span></label>
                    <div class="col-sm-6">
		...
		<div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Đăng nhập ở đây <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[11]" value="<?php echo $lang_ids[11]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Trở về trang đăng nhập <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[12]" value="<?php echo $lang_ids[12]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Tên đăng nhập <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Khách hàng đăng kí <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[16]" value="<?php echo $lang_ids[16]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Đăng kí thành công <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Giỏ <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Về giỏ hàng <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Xử lí thanh toán <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[23]" value="<?php echo $lang_ids[23]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Hãy đăng nhập khi thanh toán <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Thông tin gửi tới<span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[43]" value="<?php echo $lang_ids[43]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Chi tiết giao dịch <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[44]" value="<?php echo $lang_ids[44]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Thông tin ID và các thông tin khác<span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">				
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Xem tất cả sản phẩm liên quan <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[156]" value="<?php echo $lang_ids[156]; ?>">
                    </div>
                </div>			
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Phân loại <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Tất cả sản phẩm bên dưới <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Chi sẻ sản phẩm <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Chức năng <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Đưa tra đánh giá <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[65]" value="<?php echo $lang_ids[65]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Thêm nhận xét của bạn<span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[66]" value="<?php echo $lang_ids[66]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Lưu đánh giá<span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[67]" value="<?php echo $lang_ids[67]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Đã đưa ra bài đánh giá<span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[68]" value="<?php echo $lang_ids[68]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Bài đánh giá đã được gửi <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[163]" value="<?php echo $lang_ids[163]; ?>">
                    </div>
                </div>	
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Hãy đăng nhập trước khi đánh giá<span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[69]" value="<?php echo $lang_ids[69]; ?>">
                    </div>
                </div>					
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Không tìm thấy mô tả nào<span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[70]" value="<?php echo $lang_ids[70]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">   Không tìm thấy chức năng nào <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[71]" value="<?php echo $lang_ids[71]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Không tìm thấy điều kiện nào<span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[72]" value="<?php echo $lang_ids[72]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Không có chính sách hoàn trả nào<span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[73]" value="<?php echo $lang_ids[73]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Không tìm thấy bài đánh giá nào <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Các bình luận <span>*</span></label>
                    <div class="col-sm-6">
