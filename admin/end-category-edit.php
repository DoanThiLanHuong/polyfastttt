        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Danh mục cấp cao <span>*</span></label>
                    <div class="col-sm-4">
                        <select name="tcat_id" class="form-control select2 top-cat">
                            <option value="">Danh mục cấp cao</option>
                            <?php
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Danh mục trung cấp <span>*</span></label>
                    <div class="col-sm-4">
                        <select name="mcat_id" class="form-control select2 mid-cat">
                            <option value="">Danh mục trung cấp</option>
                            <?php
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Danh mục cấp thấp <span>*</span></label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <button type="submit" class="btn btn-success pull-left" name="form1">Tải lên</button>
                    </div>
                </div>
