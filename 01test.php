...
<html>
  <head>
    ...
    <title>AdminLTE 2 | Bảng điều khiển</title>
                    ...
                    <ul class="menu">
                      <li>
                        ...
                        <a href="#">
                          ...
                          <p>Tại sao không mua một chủ đề tuyệt vời mới?</p>
                        </a>
                      </li>
                      <!-- end message -->
                      <li>
                      ...
                      <li>
                        <a href="#">
                          ...
                          <h4>
                            Sales Department
                            <small
                              ><i class="fa fa-clock-o"></i> Hôm qua</small
                            >
                          </h4>
                          <p>Tại sao không mua một chủ đề tuyệt vời mới?</p>
                        </a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <i class="fa fa-warning text-yellow"></i> Rất dài
                          mô tả ở đây có thể không vừa với trang và
                          có thể gây ra vấn đề về thiết kế
                        </a>
                      </li>
                      <li>
                        <a href="#">
                      ...
                      <li>
                        <a href="#">
                          ...
                          doanh số bán hàng được thực hiện
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="fa fa-user text-red"></i> Bạn đã thay đổi
                          tên tài khoản
                        </a>
                      </li>
                    </ul>
                        ...
                        <a href="#">
                          ...
                          <div class="progress xs">
                            <div
                              ...
                              aria-valuemax="100"
                            >
                              <span class="sr-only">40% Hoàn thành</span>
                            </div>
                          </div>
                        </a>
                      </li>
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img
                    ...
                    alt="User Image"
                  />
                  <span class="hidden-xs">MEEP</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    ...
                    <p>
                      MEEP - Web Developer
                      <small>Thành viên từ tháng 11 năm 2013</small>
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
